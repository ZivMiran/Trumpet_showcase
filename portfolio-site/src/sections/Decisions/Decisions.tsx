...
/**
 * 02 / The decisions — the screens are evidence, not the exhibit. Each entry
 * leads with one design call, shows it close-up where it lives in the UI, and
 * keeps the full screen as a dim contextual thumbnail. Crop boxes and marker
