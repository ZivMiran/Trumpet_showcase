...
/**
 * 15 — The hardest problem: the Compare engine, shown as it actually runs.
 ...
 * flip as the flow unfolds.
 *
 * Seeking has latency, so the scrub isn't event-driven like the screen
 * sequences: an IntersectionObserver-gated rAF loop lerps toward the target
  ...
  return (
    <div className="cstudy">
      <div className="container">
        <ChapterHeader no="15" title="The hardest problem" />
