...
const FRAMES: SeqFrame[] = [
  {
    ...
    caption: 'Overview — your week, answered in a sentence.',
    width: SCREEN_W,
    height: SCREEN_H,
  },
  {
    ...
    caption: 'Music — the catalog, ranked by this week’s movers.',
    width: SCREEN_W,
    height: SCREEN_H,
  },
  {
    ...
    caption: 'Track detail — where listeners skip, and where they save.',
    width: SCREEN_W,
    height: SCREEN_H,
  },
  {
    ...
    caption: 'Audience — who’s listening, and exactly where.',
    width: SCREEN_W,
    height: SCREEN_H,
  },
]
